  ...
  computed: {
    ...
    navbarHeight() {
      if (this.fixed && this.height === 0) {
        const menuBtnInfo = common_vendor.index.getMenuButtonBoundingClientRect();
        const winInfo = common_vendor.index.getWindowInfo();
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    y: $props.showMenuButtonWidth ? $data.navWidth + "px" : "100%",
    z: $props.fixed ? 1 : "",
    A: $props.shadow ? 1 : "",
    B: $props.border ? 1 : "",
